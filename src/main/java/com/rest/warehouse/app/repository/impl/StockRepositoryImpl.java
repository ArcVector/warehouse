...
import com.rest.warehouse.app.repository.StockRepositoryCustom;
import com.rest.warehouse.app.search.StockSearchCriteria;
import java.util.HashMap;
import javax.persistence.EntityManager;
import javax.persistence.PersistenceContext;
import org.apache.commons.lang3.StringUtils;
import target.model.QStock;
...
public class StockRepositoryImpl extends QueryExecutor implements StockRepositoryCustom {
    ...
    private Predicate predicateOf(StockSearchCriteria criteria)
    {
        ...
        if(shelfId !=null)
        {
         ...
         String shelfCode = criteria.getShelfCode();
                ...
                {
                    predicate.and(qStock.warehouseDescription.containsIgnoreCase(shelfCode));
                }
        ...
        String warehouseDescription = criteria.getWarehouseDescription();
                if(StringUtils.isNotBlank(warehouseDescription))
                {
    ...
    private HashMap<String, Path> orderMap()
    {
        ...
        map.put(StockSearchCriteria.ORDER_BY_SHELF_CODE, qStock.productCode);
